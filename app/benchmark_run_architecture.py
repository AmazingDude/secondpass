...
def run_architecture_benchmark(
    *,
    ...
    for fixture_key in fixture_keys:
        ...
        # Same conflation as Security's rate-limit case (app/benchmark_run.py):
        # an LLM call that failed/rate-limited must not look identical to an
        # honest "no issues" result. review_architecture flags this via
        # report["inconclusive"]; persist it and exclude the fixture from
        # this run's precision/recall denominator instead of silently
        # inflating false_negatives.
